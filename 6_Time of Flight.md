...
We usually prefer Continuous Wave Modulation over Pulse Light Modulation since it's cheaper. However, if we had a lot of many, we could also purchase a system using Pulse Light modulation.